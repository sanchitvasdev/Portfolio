...
import { useActiveSectionContext } from "@/context/active-context-context";
    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="https://media.licdn.com/dms/image/D4D03AQE95kz9quBAnQ/profile-displayphoto-shrink_400_400/0/1686769408539?e=1717632000&v=beta&t=4Do-DyoAIE0-8cQ4MKYuIxjHqwzf1SDC-vTfGNM8yp4&fit=crop&w=368&h=368&q=100"
              alt="Sanchhit photo"
              width="192"
              height="192"
              quality="95"
      ...
      >
        <span className="font-bold">Hello, I am Sanchit.</span> I am a{" "}
        <span className="font-bold">Full-stack web developer</span> with{" "}
        <span className="font-bold">1 year</span> of experience. I enjoy
        building <span className="italic">sites & apps</span>. My focus is{" "}
        <br />
        <span className="underline">ReactJS and NodeJS</span>.
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/sanchitvasdev/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/sanchitvasdev"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
